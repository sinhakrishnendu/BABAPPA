...
- low: branch IDs `unavailable`; foreground taxa `unavailable`
- moderate: branch IDs `unavailable`; foreground taxa `unavailable`
- high: branch IDs `unavailable`; foreground taxa `unavailable`
- extreme: branch IDs `unavailable`; foreground taxa `unavailable`
